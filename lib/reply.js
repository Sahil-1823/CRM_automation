...
function sentimentGuidance(sentiment, isPositive) {
  ...
  if (sentiment === "negative/neutral") {
    return "The lead seems negative or neutral — stay polite and brief, but still write a complete helpful reply (acknowledge, answer questions, or leave the door open). ";
  }
  return "Always write a complete draft reply tailored to what the lead said. ";
}
