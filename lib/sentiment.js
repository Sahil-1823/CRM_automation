    ...
    messages: [
      {
        role: "system",
        content:
          'Classify LinkedIn outreach replies as "positive", "negative", or "neutral". ' +
          'Use "positive" when the lead expresses interest, asks to learn more, agrees to a call, ' +
          'or otherwise signals openness to continue. Use "negative" for clear rejections, ' +
          'unsubscribe requests, or explicit disinterest. Use "neutral" for vague, non-committal, ' +
          "or unclear responses that are not clearly positive or negative.",
      },
      {
        role: "user",
        content: userContent,
