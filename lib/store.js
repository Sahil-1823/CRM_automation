  ...
  const out = {
    ...
    draft: {
      ...
      scheduling: draft.scheduling
        ? {
            intent: !!draft.scheduling.intent,
            mode: draft.scheduling.mode ?? null,
            requestedTime: draft.scheduling.requestedTime ?? null,
            status: draft.scheduling.status ?? null,
            calendlyLink: draft.scheduling.calendlyLink ?? null,
            proposedSlots: (draft.scheduling.proposedSlots ?? []).map((s) => ({
              start: s.start,
              end: s.end,
              label: s.label ?? null,
            })),
            pendingBook: draft.scheduling.pendingBook
              ? {
                  start: draft.scheduling.pendingBook.start,
                  end: draft.scheduling.pendingBook.end,
                  title: draft.scheduling.pendingBook.title,
                  label: draft.scheduling.pendingBook.label ?? null,
                }
              : null,
            calendarEventId: draft.scheduling.calendarEventId ?? null,
            meetLink: draft.scheduling.meetLink ?? null,
            calendarError: draft.scheduling.calendarError ?? null,
          }
        : null,
