...
} from "../../lib/calendar/google.js";
import { saveGoogleOAuthTokens, clearGoogleOAuthTokens } from "../../lib/calendar/store.js";
...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (action === "connect") {
      ...
      const { clientId } = (await import("../../lib/calendar/config.js")).getGoogleCalendarConfig();
